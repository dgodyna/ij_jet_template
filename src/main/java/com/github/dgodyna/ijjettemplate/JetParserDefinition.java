...
import com.github.dgodyna.ijjettemplate.parser.JetParser;
import com.github.dgodyna.ijjettemplate.psi.JetFile;
...
public class JetParserDefinition implements ParserDefinition {
    ...
    public static final IFileElementType FILE = new IFileElementType(JetLanguage.getINSTANCE());
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new JetFile(viewProvider);
    }
    ...
    public PsiElement createElement(ASTNode node) {
        return JetTypes.Factory.createElement(node);
    }
